			...
			<div className={styles.bottomwrap}>
				...
				<div className={styles.aboutwrap}>
					...
					<p className={styles.smallp}>
						...
						every customer, regardless of the size of the company and its
						budget. Our web design company specializes in the professional
						creation of unique sites.{' '}
					</p>
					...
					<div className={styles.whyusmegawrap}>
						<div className={styles.whyuswrap}>
							...
							<p className={styles.largep}>
								I appreciate every client and am ready to help with all the
							...
							<ul className={styles.listwrap}>
								<li className={styles.listitem}>
									...
									<p className={styles.smallp}>
										The approach to each new project is individual, I treat
								...
								<li className={styles.listitem}>
									...
									<p className={styles.smallp}>
										Open lines of communication and a strong work ethic for all
										who choose me.
									</p>
								</li>
								<li className={styles.listitem}>
