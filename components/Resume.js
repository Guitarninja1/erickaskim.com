			...
			<div className={styles.Resume}>
				<div className={styles.ResumeSlider}>
					...
					<p className={styles.resumeBody}>
						...
						excellence. Possess excellent planning, organization, time
						management and decision-making skills. Self-driven team player with
						strengths in communication and developing interpersonal
						relationships.
					</p>
					<h3>Skills</h3>
					...
					<ul className={styles.experienceUl}>
						...
						<ul>
							...
							<li>
								Create product sets linking individual products to an overall
								set
							</li>
						</ul>
					</ul>
					...
					<ul className={styles.educationUl}>
						<li className={styles.kyle}>
							Apprenticeship Under Kyle Melton: July 6th 2020 - Current{' '}
							<br></br>
